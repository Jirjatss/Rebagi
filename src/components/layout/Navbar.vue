<template>
  <div :class="[isNavbar ? 'navbar bg-[#00AF91] fixed z-50 py-5 lg:px-28 px-10 font-mulish' : 'navbar bg-transparent fixed z-50 py-5 lg:px-28 px-10 font-mulish']" v-on:scroll="changeBg">
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal px-1 text-white text-[20px] font-thin">
        <li><a>Beranda</a></li>
        <li><a>Ayo Donasi</a></li>
        <li><a>Buka Donasi</a></li>
        <li><a>Tentang Kami</a></li>
    ...
    <div class="navbar-end gap-3 font-bold">
      <a :class="[isNavbar ? 'py-2 px-8 bg-white text-[#00AF91]  border-white border-2 rounded-lg  cursor-pointer hidden md:flex' : '  py-2 px-8 bg-[#00AF91] border-white border-2 rounded-lg text-white cursor-pointer hidden md:flex']"
        >Masuk</a
      >
      <a :class="[isNavbar ? 'py-2 px-8 bg-[#00AF91] border-white border-2 rounded-lg text-white cursor-pointer ' : 'py-2 px-8 bg-white text-[#00AF91]  border-white border-2 rounded-lg  cursor-pointer me-5']">Daftar</a>
    </div>
  </div>
</template>
